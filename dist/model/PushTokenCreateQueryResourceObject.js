...
var _PushTokenCreateQueryResourceObjectAttributes = require("./PushTokenCreateQueryResourceObjectAttributes.js");
var _PushTokenEnum = require("./PushTokenEnum.js");
 ...
 * @version 2023-08-15
 */
var PushTokenCreateQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function PushTokenCreateQueryResourceObject(type, attributes) {
    _classCallCheck(this, PushTokenCreateQueryResourceObject);
    this.type = type;
   ...
   */
  _createClass(PushTokenCreateQueryResourceObject, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PushTokenCreateQueryResourceObject();
        if (data.hasOwnProperty('type')) obj.type = _PushTokenEnum.PushTokenEnum.constructFromObject(data['type']);
        if (data.hasOwnProperty('attributes')) obj.attributes = _PushTokenCreateQueryResourceObjectAttributes.PushTokenCreateQueryResourceObjectAttributes.constructFromObject(data['attributes']);
      }
      return obj;
    }
  }]);
  return PushTokenCreateQueryResourceObject;
}();
/**
