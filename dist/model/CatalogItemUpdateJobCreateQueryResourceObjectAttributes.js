  ...
  _createClass(CatalogItemUpdateJobCreateQueryResourceObjectAttributes, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) obj.items = _ApiClient.ApiClient.convertToType(data['items'], [_CatalogItemUpdateQueryResourceObject.CatalogItemUpdateQueryResourceObject]);
      }
      return obj;
    }
  }]);
