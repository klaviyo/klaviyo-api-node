...
var _TagFlowOpData = require("./TagFlowOpData.js");
 ...
 * @version 2023-07-15
 */
var TagFlowOp = /*#__PURE__*/function () {
  /**
   ...
   */
  function TagFlowOp(data) {
    _classCallCheck(this, TagFlowOp);
    this.data = data;
  }
   ...
   */
  _createClass(TagFlowOp, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TagFlowOp();
        if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_TagFlowOpData.TagFlowOpData]);
      }
      return obj;
    }
  }]);
