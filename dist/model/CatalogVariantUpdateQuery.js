...
var CatalogVariantUpdateQuery = /*#__PURE__*/function () {
   ...
   * @class
   * @param data {module:model/CatalogVariantUpdateQueryResourceObject} 
   */
  ...
  _createClass(CatalogVariantUpdateQuery, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) obj.data = _CatalogVariantUpdateQueryResourceObject.CatalogVariantUpdateQueryResourceObject.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
...
/**
 * @member {module:model/CatalogVariantUpdateQueryResourceObject} data
 */
