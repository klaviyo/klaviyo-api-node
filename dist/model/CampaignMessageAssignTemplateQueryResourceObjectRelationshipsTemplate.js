...
var _CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplateData = require("./CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplateData.js");
 ...
 * @version 2023-07-15
 */
var CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate = /*#__PURE__*/function () {
  /**
   ...
   */
  function CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate(data) {
    _classCallCheck(this, CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate);
    this.data = data;
  }
   ...
   */
  _createClass(CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate();
        if (data.hasOwnProperty('data')) obj.data = _CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplateData.CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplateData.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
  return CampaignMessageAssignTemplateQueryResourceObjectRelationshipsTemplate;
}();
/**
