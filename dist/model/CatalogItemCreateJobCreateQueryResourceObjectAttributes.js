  ...
  _createClass(CatalogItemCreateJobCreateQueryResourceObjectAttributes, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) obj.items = _ApiClient.ApiClient.convertToType(data['items'], [_CatalogItemCreateQueryResourceObject.CatalogItemCreateQueryResourceObject]);
      }
      return obj;
    }
  }]);
