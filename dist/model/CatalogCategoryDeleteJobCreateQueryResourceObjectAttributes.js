  ...
  _createClass(CatalogCategoryDeleteJobCreateQueryResourceObjectAttributes, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('categories')) obj.categories = _ApiClient.ApiClient.convertToType(data['categories'], [_CatalogCategoryDeleteQueryResourceObject.CatalogCategoryDeleteQueryResourceObject]);
      }
      return obj;
    }
  }]);
