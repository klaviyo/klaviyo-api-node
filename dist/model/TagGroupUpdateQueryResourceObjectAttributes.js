 ...
 * @version 2023-02-22
 */
var TagGroupUpdateQueryResourceObjectAttributes = /*#__PURE__*/function () {
  /**
   ...
   */
  function TagGroupUpdateQueryResourceObjectAttributes(name) {
    _classCallCheck(this, TagGroupUpdateQueryResourceObjectAttributes);
    this.name = name;
  }
   ...
   */
  _createClass(TagGroupUpdateQueryResourceObjectAttributes, null, [{
  ...
  return TagGroupUpdateQueryResourceObjectAttributes;
}();
/**
 * The Tag Group name
 * @member {String} name
