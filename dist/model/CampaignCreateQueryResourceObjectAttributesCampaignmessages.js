...
var _CampaignMessageCreateQueryResourceObject = require("./CampaignMessageCreateQueryResourceObject.js");
 ...
 * @version 2023-07-15
 */
var CampaignCreateQueryResourceObjectAttributesCampaignmessages = /*#__PURE__*/function () {
  /**
   ...
   */
  function CampaignCreateQueryResourceObjectAttributesCampaignmessages(data) {
    _classCallCheck(this, CampaignCreateQueryResourceObjectAttributesCampaignmessages);
    this.data = data;
  }
   ...
   */
  _createClass(CampaignCreateQueryResourceObjectAttributesCampaignmessages, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CampaignCreateQueryResourceObjectAttributesCampaignmessages();
        if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_CampaignMessageCreateQueryResourceObject.CampaignMessageCreateQueryResourceObject]);
      }
      return obj;
    }
  }]);
  return CampaignCreateQueryResourceObjectAttributesCampaignmessages;
}();
/**
