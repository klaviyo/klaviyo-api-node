 ...
 * @version 2023-07-15
 */
var TagCreateQueryResourceObjectRelationshipsTaggroupData = /*#__PURE__*/function () {
  /**
   ...
   * @param id {String} 
   */
  function TagCreateQueryResourceObjectRelationshipsTaggroupData(type, id) {
    _classCallCheck(this, TagCreateQueryResourceObjectRelationshipsTaggroupData);
    this.type = type;
    this.id = id;
  }
   ...
   */
  _createClass(TagCreateQueryResourceObjectRelationshipsTaggroupData, null, [{
  ...
  return TagCreateQueryResourceObjectRelationshipsTaggroupData;
}();
/**
