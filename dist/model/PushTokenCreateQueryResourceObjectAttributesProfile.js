...
var _ProfileUpsertQueryResourceObject = require("./ProfileUpsertQueryResourceObject.js");
 ...
 * @version 2023-08-15
 */
var PushTokenCreateQueryResourceObjectAttributesProfile = /*#__PURE__*/function () {
  /**
   ...
   */
  function PushTokenCreateQueryResourceObjectAttributesProfile(data) {
    _classCallCheck(this, PushTokenCreateQueryResourceObjectAttributesProfile);
    this.data = data;
  }
   ...
   */
  _createClass(PushTokenCreateQueryResourceObjectAttributesProfile, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PushTokenCreateQueryResourceObjectAttributesProfile();
        if (data.hasOwnProperty('data')) obj.data = _ProfileUpsertQueryResourceObject.ProfileUpsertQueryResourceObject.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
  return PushTokenCreateQueryResourceObjectAttributesProfile;
}();
/**
