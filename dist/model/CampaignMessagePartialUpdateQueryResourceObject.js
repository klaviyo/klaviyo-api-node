...
var _CampaignMessagePartialUpdateQueryResourceObjectAttributes = require("./CampaignMessagePartialUpdateQueryResourceObjectAttributes.js");
 ...
 * @version 2023-06-15
 */
var CampaignMessagePartialUpdateQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function CampaignMessagePartialUpdateQueryResourceObject(attributes, type, id) {
    _classCallCheck(this, CampaignMessagePartialUpdateQueryResourceObject);
   ...
   */
  _createClass(CampaignMessagePartialUpdateQueryResourceObject, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CampaignMessagePartialUpdateQueryResourceObject();
        if (data.hasOwnProperty('attributes')) obj.attributes = _CampaignMessagePartialUpdateQueryResourceObjectAttributes.CampaignMessagePartialUpdateQueryResourceObjectAttributes.constructFromObject(data['attributes']);
  ...
  return CampaignMessagePartialUpdateQueryResourceObject;
}();
/**
