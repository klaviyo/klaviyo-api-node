 ...
 * @version 2023-07-15
 */
var CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories = /*#__PURE__*/function () {
  /**
   ...
   */
  function CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories(data) {
    _classCallCheck(this, CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories);
    this.data = data;
  }
   ...
   */
  _createClass(CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories();
        if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_CatalogCategoryUpdateQueryResourceObject.CatalogCategoryUpdateQueryResourceObject]);
      }
      return obj;
    }
  }]);
  return CatalogCategoryUpdateJobCreateQueryResourceObjectAttributesCategories;
}();
/**
