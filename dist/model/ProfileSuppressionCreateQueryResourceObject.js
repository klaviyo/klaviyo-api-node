...
var _ProfileSuppressionCreateQueryResourceObjectAttributes = require("./ProfileSuppressionCreateQueryResourceObjectAttributes.js");
 ...
 * @version 2023-07-15
 */
var ProfileSuppressionCreateQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function ProfileSuppressionCreateQueryResourceObject(attributes, type) {
    _classCallCheck(this, ProfileSuppressionCreateQueryResourceObject);
   ...
   */
  _createClass(ProfileSuppressionCreateQueryResourceObject, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ProfileSuppressionCreateQueryResourceObject();
        if (data.hasOwnProperty('attributes')) obj.attributes = _ProfileSuppressionCreateQueryResourceObjectAttributes.ProfileSuppressionCreateQueryResourceObjectAttributes.constructFromObject(data['attributes']);
        if (data.hasOwnProperty('type')) obj.type = _ProfileEnum.ProfileEnum.constructFromObject(data['type']);
      }
      return obj;
    }
  }]);
  return ProfileSuppressionCreateQueryResourceObject;
}();
/**
