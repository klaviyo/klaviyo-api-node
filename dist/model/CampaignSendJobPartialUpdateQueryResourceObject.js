...
var _CampaignSendJobPartialUpdateQueryResourceObjectAttributes = require("./CampaignSendJobPartialUpdateQueryResourceObjectAttributes.js");
 ...
 * @version 2023-02-22
 */
var CampaignSendJobPartialUpdateQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function CampaignSendJobPartialUpdateQueryResourceObject(type, id, attributes) {
    _classCallCheck(this, CampaignSendJobPartialUpdateQueryResourceObject);
    this.type = type;
    this.id = id;
   ...
   */
  _createClass(CampaignSendJobPartialUpdateQueryResourceObject, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('attributes')) obj.attributes = _CampaignSendJobPartialUpdateQueryResourceObjectAttributes.CampaignSendJobPartialUpdateQueryResourceObjectAttributes.constructFromObject(data['attributes']);
      }
      return obj;
    }
  }]);
  return CampaignSendJobPartialUpdateQueryResourceObject;
}();
/**
