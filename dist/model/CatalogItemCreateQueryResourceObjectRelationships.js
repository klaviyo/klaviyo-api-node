...
var _CatalogItemCreateQueryResourceObjectRelationshipsCategories = require("./CatalogItemCreateQueryResourceObjectRelationshipsCategories.js");
 ...
 * @version 2023-06-15
 */
var CatalogItemCreateQueryResourceObjectRelationships = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function CatalogItemCreateQueryResourceObjectRelationships() {
    _classCallCheck(this, CatalogItemCreateQueryResourceObjectRelationships);
  }
   ...
   */
  _createClass(CatalogItemCreateQueryResourceObjectRelationships, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CatalogItemCreateQueryResourceObjectRelationships();
        if (data.hasOwnProperty('categories')) obj.categories = _CatalogItemCreateQueryResourceObjectRelationshipsCategories.CatalogItemCreateQueryResourceObjectRelationshipsCategories.constructFromObject(data['categories']);
      }
      return obj;
    }
  }]);
  return CatalogItemCreateQueryResourceObjectRelationships;
}();
/**
