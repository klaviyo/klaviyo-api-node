...
var _EmailChannel = require("./EmailChannel.js");
var _SMSChannel = require("./SMSChannel.js");
  ...
  _createClass(Subscriptions, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('email')) obj.email = _EmailChannel.EmailChannel.constructFromObject(data['email']);
        if (data.hasOwnProperty('sms')) obj.sms = _SMSChannel.SMSChannel.constructFromObject(data['sms']);
      }
      return obj;
    }
  }]);
