 ...
 * @version 2023-07-15
 */
var CatalogVariantCreateQueryResourceObjectRelationshipsItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function CatalogVariantCreateQueryResourceObjectRelationshipsItem(data) {
    _classCallCheck(this, CatalogVariantCreateQueryResourceObjectRelationshipsItem);
    this.data = data;
  }
   ...
   */
  _createClass(CatalogVariantCreateQueryResourceObjectRelationshipsItem, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CatalogVariantCreateQueryResourceObjectRelationshipsItem();
        if (data.hasOwnProperty('data')) obj.data = _CatalogCategoryUpdateQueryResourceObjectRelationshipsItemsData.CatalogCategoryUpdateQueryResourceObjectRelationshipsItemsData.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
  return CatalogVariantCreateQueryResourceObjectRelationshipsItem;
}();
/**
