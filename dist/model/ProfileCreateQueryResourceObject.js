...
var _ProfileCreateQueryResourceObjectAttributes = require("./ProfileCreateQueryResourceObjectAttributes.js");
 ...
 * @version 2023-06-15
 */
var ProfileCreateQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function ProfileCreateQueryResourceObject(attributes, type) {
    _classCallCheck(this, ProfileCreateQueryResourceObject);
   ...
   */
  _createClass(ProfileCreateQueryResourceObject, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ProfileCreateQueryResourceObject();
        if (data.hasOwnProperty('attributes')) obj.attributes = _ProfileCreateQueryResourceObjectAttributes.ProfileCreateQueryResourceObjectAttributes.constructFromObject(data['attributes']);
        if (data.hasOwnProperty('type')) obj.type = _ProfileEnum.ProfileEnum.constructFromObject(data['type']);
      }
      return obj;
    }
  }]);
  return ProfileCreateQueryResourceObject;
}();
/**
