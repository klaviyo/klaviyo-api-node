...
var _TagCreateQueryResourceObject = require("./TagCreateQueryResourceObject.js");
...
var TagCreateQuery = /*#__PURE__*/function () {
   ...
   * @class
   * @param data {module:model/TagCreateQueryResourceObject} 
   */
  ...
  _createClass(TagCreateQuery, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) obj.data = _TagCreateQueryResourceObject.TagCreateQueryResourceObject.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
...
/**
 * @member {module:model/TagCreateQueryResourceObject} data
 */
