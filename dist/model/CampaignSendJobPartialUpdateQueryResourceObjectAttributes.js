 ...
 * @version 2023-06-15
 */
var CampaignSendJobPartialUpdateQueryResourceObjectAttributes = /*#__PURE__*/function () {
  /**
   ...
   */
  function CampaignSendJobPartialUpdateQueryResourceObjectAttributes(action) {
    _classCallCheck(this, CampaignSendJobPartialUpdateQueryResourceObjectAttributes);
    this.action = action;
  }
   ...
   */
  _createClass(CampaignSendJobPartialUpdateQueryResourceObjectAttributes, null, [{
  ...
  return CampaignSendJobPartialUpdateQueryResourceObjectAttributes;
}();
/**
