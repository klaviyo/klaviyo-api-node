...
var _CatalogItemUpdateQueryResourceObject = require("./CatalogItemUpdateQueryResourceObject.js");
 ...
 * @version 2023-08-15
 */
var CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems = /*#__PURE__*/function () {
  /**
   ...
   */
  function CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems(data) {
    _classCallCheck(this, CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems);
    this.data = data;
  }
   ...
   */
  _createClass(CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems();
        if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_CatalogItemUpdateQueryResourceObject.CatalogItemUpdateQueryResourceObject]);
      }
      return obj;
    }
  }]);
  return CatalogItemUpdateJobCreateQueryResourceObjectAttributesItems;
}();
/**
