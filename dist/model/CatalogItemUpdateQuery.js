...
var CatalogItemUpdateQuery = /*#__PURE__*/function () {
   ...
   * @class
   * @param data {module:model/CatalogItemUpdateQueryResourceObject} 
   */
  ...
  _createClass(CatalogItemUpdateQuery, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) obj.data = _CatalogItemUpdateQueryResourceObject.CatalogItemUpdateQueryResourceObject.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
...
/**
 * @member {module:model/CatalogItemUpdateQueryResourceObject} data
 */
