...
var _SubscriptionDeleteJobCreateQueryResourceObjectAttributesProfiles = require("./SubscriptionDeleteJobCreateQueryResourceObjectAttributesProfiles.js");
 ...
 * @version 2023-08-15
 */
var SubscriptionDeleteJobCreateQueryResourceObjectAttributes = /*#__PURE__*/function () {
  /**
   ...
   */
  function SubscriptionDeleteJobCreateQueryResourceObjectAttributes(profiles) {
    _classCallCheck(this, SubscriptionDeleteJobCreateQueryResourceObjectAttributes);
   ...
   */
  _createClass(SubscriptionDeleteJobCreateQueryResourceObjectAttributes, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SubscriptionDeleteJobCreateQueryResourceObjectAttributes();
        if (data.hasOwnProperty('profiles')) obj.profiles = _SubscriptionDeleteJobCreateQueryResourceObjectAttributesProfiles.SubscriptionDeleteJobCreateQueryResourceObjectAttributesProfiles.constructFromObject(data['profiles']);
      }
      return obj;
    }
  }]);
  return SubscriptionDeleteJobCreateQueryResourceObjectAttributes;
}();
/**
