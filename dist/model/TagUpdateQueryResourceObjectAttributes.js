...
exports.TagUpdateQueryResourceObjectAttributes = void 0;
 ...
 * @version 2023-07-15
 */
var TagUpdateQueryResourceObjectAttributes = /*#__PURE__*/function () {
  /**
   ...
   */
  function TagUpdateQueryResourceObjectAttributes(name) {
    _classCallCheck(this, TagUpdateQueryResourceObjectAttributes);
    this.name = name;
  }
   ...
   */
  _createClass(TagUpdateQueryResourceObjectAttributes, null, [{
  ...
  return TagUpdateQueryResourceObjectAttributes;
}();
/**
 * The Tag name
 * @member {String} name
 */
exports.TagUpdateQueryResourceObjectAttributes = TagUpdateQueryResourceObjectAttributes;
