 ...
 * @version 2023-07-15
 */
var CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants = /*#__PURE__*/function () {
  /**
   ...
   */
  function CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants(data) {
    _classCallCheck(this, CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants);
    this.data = data;
  }
   ...
   */
  _createClass(CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants();
        if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_CatalogVariantCreateQueryResourceObject.CatalogVariantCreateQueryResourceObject]);
      }
      return obj;
    }
  }]);
  return CatalogVariantCreateJobCreateQueryResourceObjectAttributesVariants;
}();
/**
