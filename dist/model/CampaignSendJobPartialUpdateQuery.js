...
var _CampaignSendJobPartialUpdateQueryAsSubResource = require("./CampaignSendJobPartialUpdateQueryAsSubResource.js");
...
var CampaignSendJobPartialUpdateQuery = /*#__PURE__*/function () {
   ...
   * @class
   * @param data {module:model/CampaignSendJobPartialUpdateQueryAsSubResource} 
   */
  ...
  _createClass(CampaignSendJobPartialUpdateQuery, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) obj.data = _CampaignSendJobPartialUpdateQueryAsSubResource.CampaignSendJobPartialUpdateQueryAsSubResource.constructFromObject(data['data']);
      }
      return obj;
    }
  }]);
...
/**
 * @member {module:model/CampaignSendJobPartialUpdateQueryAsSubResource} data
 */
