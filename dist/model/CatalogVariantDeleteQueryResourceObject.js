 ...
 * @version 2023-07-15
 */
var CatalogVariantDeleteQueryResourceObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function CatalogVariantDeleteQueryResourceObject(type, id) {
    _classCallCheck(this, CatalogVariantDeleteQueryResourceObject);
    this.type = type;
    this.id = id;
  }
   ...
   */
  _createClass(CatalogVariantDeleteQueryResourceObject, null, [{
  ...
  return CatalogVariantDeleteQueryResourceObject;
}();
/**
