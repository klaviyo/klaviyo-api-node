        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              returnType = Object;
              return _context.abrupt("return", _this.apiClient.callApi('/client/events/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context2.abrupt("return", _this.apiClient.callApi('/client/profiles/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              accepts = [];
              returnType = Object;
              return _context3.abrupt("return", _this.apiClient.callApi('/client/subscriptions/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
