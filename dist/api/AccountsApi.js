...
* @version 2023-06-15
*/
var AccountsApi = /*#__PURE__*/_createClass(
/**
...
function AccountsApi(apiClient) {
   ...
   * @param {Array.<module:model/String>} opts.fieldsAccount For more information please visit https://developers.klaviyo.com/en/v2023-06-15/reference/api-overview#sparse-fieldsets
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            queryParams = {
              'fields[account]': _this.apiClient.buildCollectionParam(opts['fieldsAccount'], 'csv')
            };
            headerParams = {};
            formParams = {};
            ...
            return _context.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/accounts/{id}/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/accounts/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
