...
function CampaignsApi(apiClient) {
   ...
   * @param {<&vendorExtensions.x-jsdoc-type>} body Trigger an asynchronous job to update the estimated number of recipients
   ...
   * @param {Array.<module:model/String>} opts.fieldsCampaignMessage For more information please visit https://developers.klaviyo.com/en/v2023-08-15/reference/api-overview#sparse-fieldsets
   * @param {Array.<module:model/String>} opts.fieldsCampaign For more information please visit https://developers.klaviyo.com/en/v2023-08-15/reference/api-overview#sparse-fieldsets
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignCampaignMessages", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignCampaignMessages");
          case 4:
            pathParams = {
              'id': id
            };
            queryParams = {
              'fields[campaign-message]': _this.apiClient.buildCollectionParam(opts['fieldsCampaignMessage'], 'csv'),
              'fields[campaign]': _this.apiClient.buildCollectionParam(opts['fieldsCampaign'], 'csv'),
              'fields[template]': _this.apiClient.buildCollectionParam(opts['fieldsTemplate'], 'csv'),
              'include': _this.apiClient.buildCollectionParam(opts['include'], 'csv')
            };
            headerParams = {};
            formParams = {};
            ...
            return _context8.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaigns/{id}/campaign-messages/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignMessageCampaign", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignMessageCampaign");
          case 4:
            pathParams = {
              'id': id
            };
            ...
            return _context10.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaign-messages/{id}/campaign/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignMessageRelationshipsCampaign", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignMessageRelationshipsCampaign");
          case 3:
            pathParams = {
              'id': id
            };
            ...
            return _context11.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaign-messages/{id}/relationships/campaign/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignMessageRelationshipsTemplate", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignMessageRelationshipsTemplate");
          case 3:
            pathParams = {
              'id': id
            };
            ...
            return _context12.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaign-messages/{id}/relationships/template/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignMessageTemplate", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignMessageTemplate");
          case 4:
            pathParams = {
              'id': id
            };
            ...
            return _context13.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaign-messages/{id}/template/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @param {Object} opts Optional parameters
   * @param {Array.<module:model/String>} opts.fieldsCampaignRecipientEstimation For more information please visit https://developers.klaviyo.com/en/v2023-08-15/reference/api-overview#sparse-fieldsets
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
   ...
   * @param {Object} opts Optional parameters
   * @param {Array.<module:model/String>} opts.fieldsCampaignRecipientEstimationJob For more information please visit https://developers.klaviyo.com/en/v2023-08-15/reference/api-overview#sparse-fieldsets
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignRelationshipsCampaignMessages", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee16$(_context16) {
        while (1) switch (_context16.prev = _context16.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignRelationshipsCampaignMessages");
          case 3:
            pathParams = {
              'id': id
            };
            ...
            return _context16.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaigns/{id}/relationships/campaign-messages/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
  _defineProperty(this, "getCampaignRelationshipsTags", /*#__PURE__*/function () {
        ...
        while (1) switch (_context17.prev = _context17.next) {
          ...
          case 3:
            ...
            return _context17.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaigns/{id}/relationships/tags/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
   ...
   * @param {Object} opts Optional parameters
   * @param {Array.<module:model/String>} opts.fieldsCampaignSendJob For more information please visit https://developers.klaviyo.com/en/v2023-08-15/reference/api-overview#sparse-fieldsets
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}
   */
      ...
      return _regeneratorRuntime().wrap(function _callee19$(_context19) {
        while (1) switch (_context19.prev = _context19.next) {
          case 0:
            ...
            throw new Error("Missing the required parameter 'id' when calling getCampaignTags");
          case 4:
            pathParams = {
              'id': id
            };
            ...
            return _context19.abrupt("return", (0, _exponentialBackoff.backOff)(function () {
              return _this.apiClient.callApi('/api/campaigns/{id}/tags/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return {
                  body: response_and_data.data,
                  headers: response_and_data.response.headers,
                  status: response_and_data.response.status
  ...
  _defineProperty(this, "getCampaigns", /*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(filter, opts) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
      return _regeneratorRuntime().wrap(function _callee20$(_context20) {
        while (1) switch (_context20.prev = _context20.next) {
          case 0:
            opts = opts || {};
            postBody = null; // verify the required parameter 'filter' is set
            if (!(filter === undefined || filter === null)) {
              _context20.next = 4;
              break;
            }
            throw new Error("Missing the required parameter 'filter' when calling getCampaigns");
          case 4:
            pathParams = {};
            queryParams = {
              'filter': filter,
  ...
  _defineProperty(this, "updateCampaign", /*#__PURE__*/function () {
    var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee21(body, id) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
  ...
  _defineProperty(this, "updateCampaignMessage", /*#__PURE__*/function () {
    var _ref22 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee22(body, id) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
   ...
   * @param {<&vendorExtensions.x-jsdoc-type>} body Permanently cancel the campaign, setting the status to CANCELED or
  ...
  _defineProperty(this, "updateCampaignSendJob", /*#__PURE__*/function () {
    var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee23(body, id) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
