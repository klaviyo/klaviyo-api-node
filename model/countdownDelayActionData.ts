...
export namespace CountdownDelayActionData {
    ...
    export enum DelayUntilWeekdaysEnum {
        Friday = <any> 'friday',
        Monday = <any> 'monday',
