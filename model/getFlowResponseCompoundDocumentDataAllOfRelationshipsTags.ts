...
export class GetFlowResponseCompoundDocumentDataAllOfRelationshipsTags {
    ...
    static getAttributeTypeMap() {
        return GetFlowResponseCompoundDocumentDataAllOfRelationshipsTags.attributeTypeMap;
    }
}
