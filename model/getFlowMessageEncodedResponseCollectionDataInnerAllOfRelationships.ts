...
export class GetFlowMessageEncodedResponseCollectionDataInnerAllOfRelationships {
    ...
    static getAttributeTypeMap() {
        return GetFlowMessageEncodedResponseCollectionDataInnerAllOfRelationships.attributeTypeMap;
    }
}
