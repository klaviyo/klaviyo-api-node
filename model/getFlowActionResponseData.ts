...
export class GetFlowActionResponseData extends FlowActionResponseObjectResource {
    'relationships'?: GetFlowActionResponseDataAllOfRelationships;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "GetFlowActionResponseDataAllOfRelationships"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(GetFlowActionResponseData.attributeTypeMap);
    }
}

export namespace GetFlowActionResponseData {
}
