...
export class GetFlowActionEncodedResponseCollectionDataInnerAllOfRelationships {
    ...
    static getAttributeTypeMap() {
        return GetFlowActionEncodedResponseCollectionDataInnerAllOfRelationships.attributeTypeMap;
    }
}
