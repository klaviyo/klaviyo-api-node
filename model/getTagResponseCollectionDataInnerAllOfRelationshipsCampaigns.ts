...
export class GetTagResponseCollectionDataInnerAllOfRelationshipsCampaigns {
    ...
    static getAttributeTypeMap() {
        return GetTagResponseCollectionDataInnerAllOfRelationshipsCampaigns.attributeTypeMap;
    }
}
