...
export class GetCampaignMessageResponseCollectionCompoundDocumentDataInnerAllOf {
    ...
    static getAttributeTypeMap() {
        return GetCampaignMessageResponseCollectionCompoundDocumentDataInnerAllOf.attributeTypeMap;
    }
}
