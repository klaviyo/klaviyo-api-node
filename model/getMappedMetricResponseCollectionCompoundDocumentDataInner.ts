...
export class GetMappedMetricResponseCollectionCompoundDocumentDataInner extends MappedMetricResponseObjectResource {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(GetMappedMetricResponseCollectionCompoundDocumentDataInner.attributeTypeMap);
    }
}

export namespace GetMappedMetricResponseCollectionCompoundDocumentDataInner {
}
