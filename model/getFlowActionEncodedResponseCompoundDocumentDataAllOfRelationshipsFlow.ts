...
export class GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow {
    ...
    static getAttributeTypeMap() {
        return GetFlowActionEncodedResponseCompoundDocumentDataAllOfRelationshipsFlow.attributeTypeMap;
    }
}
