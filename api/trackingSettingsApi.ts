...
export class TrackingSettingsApi {
    ...
    /**
     * Get all UTM tracking settings in an account. Returns an array with a single tracking setting.  More information about UTM tracking settings can be found [here](https://help.klaviyo.com/hc/en-us/articles/115005247808).<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`  **Scopes:** `tracking-settings:read`  [OpenAPI Spec](https://raw.githubusercontent.com/klaviyo/openapi/main/openapi/stable/apis/get_tracking_settings.json)
     * @summary Get Tracking Settings
     
     * @param fieldsTrackingSetting For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 1. Min: 1. Max: 1.
     */
    ...
    /**
     * Update the UTM tracking setting with the given account ID.  More information about UTM tracking settings can be found [here](https://help.klaviyo.com/hc/en-us/articles/115005247808).<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`  **Scopes:** `tracking-settings:write`  [OpenAPI Spec](https://raw.githubusercontent.com/klaviyo/openapi/main/openapi/stable/apis/update_tracking_setting.json)
     ...
     * @param fieldsTrackingSetting For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async updateTrackingSetting (id: string, trackingSettingPartialUpdateQuery: TrackingSettingPartialUpdateQuery, options: { fieldsTrackingSetting?: Array<'auto_add_parameters' | 'custom_parameters' | 'id' | 'utm_campaign' | 'utm_campaign.campaign' | 'utm_campaign.campaign.type' | 'utm_campaign.campaign.value' | 'utm_campaign.flow' | 'utm_campaign.flow.type' | 'utm_campaign.flow.value' | 'utm_id' | 'utm_id.campaign' | 'utm_id.campaign.type' | 'utm_id.campaign.value' | 'utm_id.flow' | 'utm_id.flow.type' | 'utm_id.flow.value' | 'utm_medium' | 'utm_medium.campaign' | 'utm_medium.campaign.type' | 'utm_medium.campaign.value' | 'utm_medium.flow' | 'utm_medium.flow.type' | 'utm_medium.flow.value' | 'utm_source' | 'utm_source.campaign' | 'utm_source.campaign.type' | 'utm_source.campaign.value' | 'utm_source.flow' | 'utm_source.flow.type' | 'utm_source.flow.value' | 'utm_term' | 'utm_term.campaign' | 'utm_term.campaign.type' | 'utm_term.campaign.value' | 'utm_term.flow' | 'utm_term.flow.type' | 'utm_term.flow.value'>,  } = {}): Promise<{ response: AxiosResponse; body: PatchTrackingSettingResponse;  }> {
