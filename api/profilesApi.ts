...
import { GetConversationResponseCollection } from '../model/getConversationResponseCollection';
...
import { GetProfileConversationsRelationshipsResponseCollection } from '../model/getProfileConversationsRelationshipsResponseCollection';
...
import { GetProfileResponsePluralConversationsCollectionCompoundDocument } from '../model/getProfileResponsePluralConversationsCollectionCompoundDocument';
import { GetProfileResponsePluralConversationsCompoundDocument } from '../model/getProfileResponsePluralConversationsCompoundDocument';
...
export class ProfilesApi {
     ...
     * @param fieldsProfileBulkImportJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async bulkImportProfiles (profileImportJobCreateQuery: ProfileImportJobCreateQuery, options: { fieldsProfileBulkImportJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'expires_at' | 'failed_count' | 'id' | 'started_at' | 'status' | 'total_count'>,  } = {}): Promise<{ response: AxiosResponse; body: PostProfileImportJobResponse;  }> {
        ...
        if (options.fieldsProfileBulkImportJob !== undefined) {
            localVarQueryParameters['fields[profile-bulk-import-job]'] = ObjectSerializer.serialize(options.fieldsProfileBulkImportJob, "Array<'completed_at' | 'completed_count' | 'created_at' | 'expires_at' | 'failed_count' | 'id' | 'started_at' | 'status' | 'total_count'>");
        }
     ...
     * @param fieldsProfileSuppressionBulkCreateJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async bulkSuppressProfiles (suppressionCreateJobCreateQuery: SuppressionCreateJobCreateQuery, options: { fieldsProfileSuppressionBulkCreateJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>,  } = {}): Promise<{ response: AxiosResponse; body: PostBulkProfileSuppressionsCreateJobResponse;  }> {
        ...
        if (options.fieldsProfileSuppressionBulkCreateJob !== undefined) {
            localVarQueryParameters['fields[profile-suppression-bulk-create-job]'] = ObjectSerializer.serialize(options.fieldsProfileSuppressionBulkCreateJob, "Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>");
        }
     ...
     * @param fieldsProfileSuppressionBulkDeleteJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async bulkUnsuppressProfiles (suppressionDeleteJobCreateQuery: SuppressionDeleteJobCreateQuery, options: { fieldsProfileSuppressionBulkDeleteJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>,  } = {}): Promise<{ response: AxiosResponse; body: PostBulkProfileSuppressionsRemoveJobResponse;  }> {
        ...
        if (options.fieldsProfileSuppressionBulkDeleteJob !== undefined) {
            localVarQueryParameters['fields[profile-suppression-bulk-delete-job]'] = ObjectSerializer.serialize(options.fieldsProfileSuppressionBulkDeleteJob, "Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>");
        }
     ...
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async createProfile (profileCreateQuery: ProfileCreateQuery, options: { additionalFieldsProfile?: Array<'subscriptions' | 'predictive_analytics'>, fieldsProfile?: Array<'created' | 'email' | 'external_id' | 'first_name' | 'id' | 'image' | 'last_event_date' | 'last_name' | 'locale' | 'location' | 'location.address1' | 'location.address2' | 'location.city' | 'location.country' | 'location.ip' | 'location.latitude' | 'location.longitude' | 'location.region' | 'location.timezone' | 'location.zip' | 'organization' | 'phone_number' | 'predictive_analytics' | 'predictive_analytics.average_days_between_orders' | 'predictive_analytics.average_order_value' | 'predictive_analytics.churn_probability' | 'predictive_analytics.expected_date_of_next_order' | 'predictive_analytics.historic_clv' | 'predictive_analytics.historic_number_of_orders' | 'predictive_analytics.predicted_clv' | 'predictive_analytics.predicted_number_of_orders' | 'predictive_analytics.ranked_channel_affinity' | 'predictive_analytics.total_clv' | 'properties' | 'subscriptions' | 'subscriptions.email' | 'subscriptions.email.marketing' | 'subscriptions.email.marketing.can_receive_email_marketing' | 'subscriptions.email.marketing.consent' | 'subscriptions.email.marketing.consent_timestamp' | 'subscriptions.email.marketing.custom_method_detail' | 'subscriptions.email.marketing.double_optin' | 'subscriptions.email.marketing.last_updated' | 'subscriptions.email.marketing.list_suppressions' | 'subscriptions.email.marketing.method' | 'subscriptions.email.marketing.method_detail' | 'subscriptions.email.marketing.suppression' | 'subscriptions.email.open_tracking' | 'subscriptions.email.open_tracking.can_receive' | 'subscriptions.email.open_tracking.consent' | 'subscriptions.email.open_tracking.consent_timestamp' | 'subscriptions.email.open_tracking.created_timestamp' | 'subscriptions.email.open_tracking.last_updated' | 'subscriptions.email.open_tracking.metadata' | 'subscriptions.email.open_tracking.valid_until' | 'subscriptions.mobile_push' | 'subscriptions.mobile_push.marketing' | 'subscriptions.mobile_push.marketing.can_receive_push_marketing' | 'subscriptions.mobile_push.marketing.consent' | 'subscriptions.mobile_push.marketing.consent_timestamp' | 'subscriptions.sms' | 'subscriptions.sms.marketing' | 'subscriptions.sms.marketing.can_receive_sms_marketing' | 'subscriptions.sms.marketing.consent' | 'subscriptions.sms.marketing.consent_timestamp' | 'subscriptions.sms.marketing.last_updated' | 'subscriptions.sms.marketing.method' | 'subscriptions.sms.marketing.method_detail' | 'subscriptions.sms.transactional' | 'subscriptions.sms.transactional.can_receive_sms_transactional' | 'subscriptions.sms.transactional.consent' | 'subscriptions.sms.transactional.consent_timestamp' | 'subscriptions.sms.transactional.last_updated' | 'subscriptions.sms.transactional.method' | 'subscriptions.sms.transactional.method_detail' | 'subscriptions.whatsapp' | 'subscriptions.whatsapp.conversational' | 'subscriptions.whatsapp.conversational.can_receive' | 'subscriptions.whatsapp.conversational.consent' | 'subscriptions.whatsapp.conversational.consent_timestamp' | 'subscriptions.whatsapp.conversational.created_timestamp' | 'subscriptions.whatsapp.conversational.last_updated' | 'subscriptions.whatsapp.conversational.metadata' | 'subscriptions.whatsapp.conversational.phone_number' | 'subscriptions.whatsapp.conversational.valid_until' | 'subscriptions.whatsapp.marketing' | 'subscriptions.whatsapp.marketing.can_receive' | 'subscriptions.whatsapp.marketing.consent' | 'subscriptions.whatsapp.marketing.consent_timestamp' | 'subscriptions.whatsapp.marketing.created_timestamp' | 'subscriptions.whatsapp.marketing.last_updated' | 'subscriptions.whatsapp.marketing.metadata' | 'subscriptions.whatsapp.marketing.phone_number' | 'subscriptions.whatsapp.marketing.valid_until' | 'subscriptions.whatsapp.transactional' | 'subscriptions.whatsapp.transactional.can_receive' | 'subscriptions.whatsapp.transactional.consent' | 'subscriptions.whatsapp.transactional.consent_timestamp' | 'subscriptions.whatsapp.transactional.created_timestamp' | 'subscriptions.whatsapp.transactional.last_updated' | 'subscriptions.whatsapp.transactional.metadata' | 'subscriptions.whatsapp.transactional.phone_number' | 'subscriptions.whatsapp.transactional.valid_until' | 'title' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: PostProfileResponse;  }> {
     ...
     * @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsProfileBulkImportJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships
     */
    public async getBulkImportProfilesJob (jobId: string, options: { fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>, fieldsProfileBulkImportJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'expires_at' | 'failed_count' | 'id' | 'started_at' | 'status' | 'total_count'>, include?: Array<'lists'>,  } = {}): Promise<{ response: AxiosResponse; body: GetProfileImportJobResponseCompoundDocument;  }> {
        ...
        if (options.fieldsList !== undefined) {
            localVarQueryParameters['fields[list]'] = ObjectSerializer.serialize(options.fieldsList, "Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>");
        }
     ...
     * @param fieldsProfileBulkImportJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;status&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
    public async getBulkImportProfilesJobs (options: { fieldsProfileBulkImportJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'expires_at' | 'failed_count' | 'id' | 'started_at' | 'status' | 'total_count'>, filter?: string, pageCursor?: string, pageSize?: number, sort?: 'created_at' | '-created_at',  } = {}): Promise<{ response: AxiosResponse; body: GetProfileImportJobResponseCollectionCompoundDocument;  }> {
     ...
     * @param fieldsProfileSuppressionBulkCreateJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getBulkSuppressProfilesJob (jobId: string, options: { fieldsProfileSuppressionBulkCreateJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>,  } = {}): Promise<{ response: AxiosResponse; body: GetBulkProfileSuppressionsCreateJobResponse;  }> {
     ...
     * @param fieldsProfileSuppressionBulkCreateJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;list_id&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;segment_id&#x60;: &#x60;equals&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
    public async getBulkSuppressProfilesJobs (options: { fieldsProfileSuppressionBulkCreateJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>, filter?: string, pageCursor?: string, sort?: 'created' | '-created',  } = {}): Promise<{ response: AxiosResponse; body: GetBulkProfileSuppressionsCreateJobResponseCollection;  }> {
     ...
     * @param fieldsProfileSuppressionBulkDeleteJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getBulkUnsuppressProfilesJob (jobId: string, options: { fieldsProfileSuppressionBulkDeleteJob?: Array<'completed_at' | 'completed_count' | 'created_at' | 'id' | 'skipped_count' | 'status' | 'total_count'>,  } = {}): Promise<{ response: AxiosResponse; body: GetBulkProfileSuppressionsRemoveJobResponse;  }> {
     ...
     * @param fieldsProfileSuppressionBulkDeleteJob For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;list_id&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;segment_id&#x60;: &#x60;equals&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
     ...
     * @param id 
     * @param fieldsConversation For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getConversationForProfile (id: string, options: { fieldsConversation?: Array<'channel' | 'id'>,  } = {}): Promise<{ response: AxiosResponse; body: GetConversationResponse;  }> {
        ...
        if (options.fieldsConversation !== undefined) {
            localVarQueryParameters['fields[conversation]'] = ObjectSerializer.serialize(options.fieldsConversation, "Array<'channel' | 'id'>");
        }
     ...
     * @summary Get Conversation IDs for Profile
     * @param id 
     
     */
    public async getConversationIdsForProfile (id: string, ): Promise<{ response: AxiosResponse; body: GetProfileConversationsRelationshipsResponseCollection;  }> {

        const localVarPath = this.basePath + '/api/profiles/{id}/relationships/conversations'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/vnd.api+json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getConversationIdsForProfile.');
        }
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetProfileConversationsRelationshipsResponseCollection;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetProfileConversationsRelationshipsResponseCollection");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @summary Get Conversations for Profile
     * @param id 
     * @param fieldsConversation For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getConversationsForProfile (id: string, options: { fieldsConversation?: Array<'channel' | 'id'>,  } = {}): Promise<{ response: AxiosResponse; body: GetConversationResponseCollection;  }> {

        const localVarPath = this.basePath + '/api/profiles/{id}/conversations'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/vnd.api+json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getConversationsForProfile.');
        }
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetConversationResponseCollection;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetConversationResponseCollection");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param id 
     * @param fieldsImportError For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.
     */
    public async getErrorsForBulkImportProfilesJob (id: string, options: { fieldsImportError?: Array<'code' | 'detail' | 'id' | 'original_payload' | 'source' | 'source.pointer' | 'title'>, pageCursor?: string, pageSize?: number,  } = {}): Promise<{ response: AxiosResponse; body: GetImportErrorResponseCollection;  }> {
        ...
        if (options.fieldsImportError !== undefined) {
            localVarQueryParameters['fields[import-error]'] = ObjectSerializer.serialize(options.fieldsImportError, "Array<'code' | 'detail' | 'id' | 'original_payload' | 'source' | 'source.pointer' | 'title'>");
        }
     ...
     * @param id 
     * @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getListForBulkImportProfilesJob (id: string, options: { fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetListResponseCollection;  }> {
     ...
     * @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getListsForProfile (id: string, options: { fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetListResponseCollection;  }> {
     ...
     * @summary Get Profile
     * @param id 
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsConversation For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsPushToken For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsSegment For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships
     */
    public async getProfile (id: string, options: { additionalFieldsProfile?: Array<'subscriptions' | 'predictive_analytics'>, fieldsConversation?: Array<'channel' | 'id'>, fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>, fieldsProfile?: Array<'created' | 'email' | 'external_id' | 'first_name' | 'id' | 'image' | 'last_event_date' | 'last_name' | 'locale' | 'location' | 'location.address1' | 'location.address2' | 'location.city' | 'location.country' | 'location.ip' | 'location.latitude' | 'location.longitude' | 'location.region' | 'location.timezone' | 'location.zip' | 'organization' | 'phone_number' | 'predictive_analytics' | 'predictive_analytics.average_days_between_orders' | 'predictive_analytics.average_order_value' | 'predictive_analytics.churn_probability' | 'predictive_analytics.expected_date_of_next_order' | 'predictive_analytics.historic_clv' | 'predictive_analytics.historic_number_of_orders' | 'predictive_analytics.predicted_clv' | 'predictive_analytics.predicted_number_of_orders' | 'predictive_analytics.ranked_channel_affinity' | 'predictive_analytics.total_clv' | 'properties' | 'subscriptions' | 'subscriptions.email' | 'subscriptions.email.marketing' | 'subscriptions.email.marketing.can_receive_email_marketing' | 'subscriptions.email.marketing.consent' | 'subscriptions.email.marketing.consent_timestamp' | 'subscriptions.email.marketing.custom_method_detail' | 'subscriptions.email.marketing.double_optin' | 'subscriptions.email.marketing.last_updated' | 'subscriptions.email.marketing.list_suppressions' | 'subscriptions.email.marketing.method' | 'subscriptions.email.marketing.method_detail' | 'subscriptions.email.marketing.suppression' | 'subscriptions.email.open_tracking' | 'subscriptions.email.open_tracking.can_receive' | 'subscriptions.email.open_tracking.consent' | 'subscriptions.email.open_tracking.consent_timestamp' | 'subscriptions.email.open_tracking.created_timestamp' | 'subscriptions.email.open_tracking.last_updated' | 'subscriptions.email.open_tracking.metadata' | 'subscriptions.email.open_tracking.valid_until' | 'subscriptions.mobile_push' | 'subscriptions.mobile_push.marketing' | 'subscriptions.mobile_push.marketing.can_receive_push_marketing' | 'subscriptions.mobile_push.marketing.consent' | 'subscriptions.mobile_push.marketing.consent_timestamp' | 'subscriptions.sms' | 'subscriptions.sms.marketing' | 'subscriptions.sms.marketing.can_receive_sms_marketing' | 'subscriptions.sms.marketing.consent' | 'subscriptions.sms.marketing.consent_timestamp' | 'subscriptions.sms.marketing.last_updated' | 'subscriptions.sms.marketing.method' | 'subscriptions.sms.marketing.method_detail' | 'subscriptions.sms.transactional' | 'subscriptions.sms.transactional.can_receive_sms_transactional' | 'subscriptions.sms.transactional.consent' | 'subscriptions.sms.transactional.consent_timestamp' | 'subscriptions.sms.transactional.last_updated' | 'subscriptions.sms.transactional.method' | 'subscriptions.sms.transactional.method_detail' | 'subscriptions.whatsapp' | 'subscriptions.whatsapp.conversational' | 'subscriptions.whatsapp.conversational.can_receive' | 'subscriptions.whatsapp.conversational.consent' | 'subscriptions.whatsapp.conversational.consent_timestamp' | 'subscriptions.whatsapp.conversational.created_timestamp' | 'subscriptions.whatsapp.conversational.last_updated' | 'subscriptions.whatsapp.conversational.metadata' | 'subscriptions.whatsapp.conversational.phone_number' | 'subscriptions.whatsapp.conversational.valid_until' | 'subscriptions.whatsapp.marketing' | 'subscriptions.whatsapp.marketing.can_receive' | 'subscriptions.whatsapp.marketing.consent' | 'subscriptions.whatsapp.marketing.consent_timestamp' | 'subscriptions.whatsapp.marketing.created_timestamp' | 'subscriptions.whatsapp.marketing.last_updated' | 'subscriptions.whatsapp.marketing.metadata' | 'subscriptions.whatsapp.marketing.phone_number' | 'subscriptions.whatsapp.marketing.valid_until' | 'subscriptions.whatsapp.transactional' | 'subscriptions.whatsapp.transactional.can_receive' | 'subscriptions.whatsapp.transactional.consent' | 'subscriptions.whatsapp.transactional.consent_timestamp' | 'subscriptions.whatsapp.transactional.created_timestamp' | 'subscriptions.whatsapp.transactional.last_updated' | 'subscriptions.whatsapp.transactional.metadata' | 'subscriptions.whatsapp.transactional.phone_number' | 'subscriptions.whatsapp.transactional.valid_until' | 'title' | 'updated'>, fieldsPushToken?: Array<'background' | 'created' | 'enablement_status' | 'id' | 'metadata' | 'metadata.app_build' | 'metadata.app_id' | 'metadata.app_name' | 'metadata.app_version' | 'metadata.device_id' | 'metadata.device_model' | 'metadata.environment' | 'metadata.klaviyo_sdk' | 'metadata.manufacturer' | 'metadata.os_name' | 'metadata.os_version' | 'metadata.sdk_version' | 'platform' | 'recorded_date' | 'token' | 'vendor'>, fieldsSegment?: Array<'created' | 'definition' | 'definition.condition_groups' | 'id' | 'is_active' | 'is_processing' | 'is_starred' | 'name' | 'updated'>, include?: Array<'conversations' | 'lists' | 'push-tokens' | 'segments'>,  } = {}): Promise<{ response: AxiosResponse; body: GetProfileResponsePluralConversationsCompoundDocument;  }> {
        ...
        if (options.fieldsPushToken !== undefined) {
            localVarQueryParameters['fields[push-token]'] = ObjectSerializer.serialize(options.fieldsPushToken, "Array<'background' | 'created' | 'enablement_status' | 'id' | 'metadata' | 'metadata.app_build' | 'metadata.app_id' | 'metadata.app_name' | 'metadata.app_version' | 'metadata.device_id' | 'metadata.device_model' | 'metadata.environment' | 'metadata.klaviyo_sdk' | 'metadata.manufacturer' | 'metadata.os_name' | 'metadata.os_version' | 'metadata.sdk_version' | 'platform' | 'recorded_date' | 'token' | 'vendor'>");
        }

        if (options.fieldsSegment !== undefined) {
            localVarQueryParameters['fields[segment]'] = ObjectSerializer.serialize(options.fieldsSegment, "Array<'created' | 'definition' | 'definition.condition_groups' | 'id' | 'is_active' | 'is_processing' | 'is_starred' | 'name' | 'updated'>");
        }

        if (options.include !== undefined) {
            localVarQueryParameters['include'] = ObjectSerializer.serialize(options.include, "Array<'conversations' | 'lists' | 'push-tokens' | 'segments'>");
        }
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetProfileResponsePluralConversationsCompoundDocument;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetProfileResponsePluralConversationsCompoundDocument");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsConversation For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsPushToken For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;email&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;phone_number&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;external_id&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;_kx&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;greater-than&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;greater-than&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;subscriptions.email.marketing.list_suppressions.reason&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;subscriptions.email.marketing.list_suppressions.timestamp&#x60;: &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;subscriptions.email.marketing.list_suppressions.list_id&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;subscriptions.email.marketing.suppression.reason&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;subscriptions.email.marketing.suppression.timestamp&#x60;: &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
    public async getProfiles (options: { additionalFieldsProfile?: Array<'subscriptions' | 'predictive_analytics'>, fieldsConversation?: Array<'channel' | 'id'>, fieldsProfile?: Array<'created' | 'email' | 'external_id' | 'first_name' | 'id' | 'image' | 'last_event_date' | 'last_name' | 'locale' | 'location' | 'location.address1' | 'location.address2' | 'location.city' | 'location.country' | 'location.ip' | 'location.latitude' | 'location.longitude' | 'location.region' | 'location.timezone' | 'location.zip' | 'organization' | 'phone_number' | 'predictive_analytics' | 'predictive_analytics.average_days_between_orders' | 'predictive_analytics.average_order_value' | 'predictive_analytics.churn_probability' | 'predictive_analytics.expected_date_of_next_order' | 'predictive_analytics.historic_clv' | 'predictive_analytics.historic_number_of_orders' | 'predictive_analytics.predicted_clv' | 'predictive_analytics.predicted_number_of_orders' | 'predictive_analytics.ranked_channel_affinity' | 'predictive_analytics.total_clv' | 'properties' | 'subscriptions' | 'subscriptions.email' | 'subscriptions.email.marketing' | 'subscriptions.email.marketing.can_receive_email_marketing' | 'subscriptions.email.marketing.consent' | 'subscriptions.email.marketing.consent_timestamp' | 'subscriptions.email.marketing.custom_method_detail' | 'subscriptions.email.marketing.double_optin' | 'subscriptions.email.marketing.last_updated' | 'subscriptions.email.marketing.list_suppressions' | 'subscriptions.email.marketing.method' | 'subscriptions.email.marketing.method_detail' | 'subscriptions.email.marketing.suppression' | 'subscriptions.email.open_tracking' | 'subscriptions.email.open_tracking.can_receive' | 'subscriptions.email.open_tracking.consent' | 'subscriptions.email.open_tracking.consent_timestamp' | 'subscriptions.email.open_tracking.created_timestamp' | 'subscriptions.email.open_tracking.last_updated' | 'subscriptions.email.open_tracking.metadata' | 'subscriptions.email.open_tracking.valid_until' | 'subscriptions.mobile_push' | 'subscriptions.mobile_push.marketing' | 'subscriptions.mobile_push.marketing.can_receive_push_marketing' | 'subscriptions.mobile_push.marketing.consent' | 'subscriptions.mobile_push.marketing.consent_timestamp' | 'subscriptions.sms' | 'subscriptions.sms.marketing' | 'subscriptions.sms.marketing.can_receive_sms_marketing' | 'subscriptions.sms.marketing.consent' | 'subscriptions.sms.marketing.consent_timestamp' | 'subscriptions.sms.marketing.last_updated' | 'subscriptions.sms.marketing.method' | 'subscriptions.sms.marketing.method_detail' | 'subscriptions.sms.transactional' | 'subscriptions.sms.transactional.can_receive_sms_transactional' | 'subscriptions.sms.transactional.consent' | 'subscriptions.sms.transactional.consent_timestamp' | 'subscriptions.sms.transactional.last_updated' | 'subscriptions.sms.transactional.method' | 'subscriptions.sms.transactional.method_detail' | 'subscriptions.whatsapp' | 'subscriptions.whatsapp.conversational' | 'subscriptions.whatsapp.conversational.can_receive' | 'subscriptions.whatsapp.conversational.consent' | 'subscriptions.whatsapp.conversational.consent_timestamp' | 'subscriptions.whatsapp.conversational.created_timestamp' | 'subscriptions.whatsapp.conversational.last_updated' | 'subscriptions.whatsapp.conversational.metadata' | 'subscriptions.whatsapp.conversational.phone_number' | 'subscriptions.whatsapp.conversational.valid_until' | 'subscriptions.whatsapp.marketing' | 'subscriptions.whatsapp.marketing.can_receive' | 'subscriptions.whatsapp.marketing.consent' | 'subscriptions.whatsapp.marketing.consent_timestamp' | 'subscriptions.whatsapp.marketing.created_timestamp' | 'subscriptions.whatsapp.marketing.last_updated' | 'subscriptions.whatsapp.marketing.metadata' | 'subscriptions.whatsapp.marketing.phone_number' | 'subscriptions.whatsapp.marketing.valid_until' | 'subscriptions.whatsapp.transactional' | 'subscriptions.whatsapp.transactional.can_receive' | 'subscriptions.whatsapp.transactional.consent' | 'subscriptions.whatsapp.transactional.consent_timestamp' | 'subscriptions.whatsapp.transactional.created_timestamp' | 'subscriptions.whatsapp.transactional.last_updated' | 'subscriptions.whatsapp.transactional.metadata' | 'subscriptions.whatsapp.transactional.phone_number' | 'subscriptions.whatsapp.transactional.valid_until' | 'title' | 'updated'>, fieldsPushToken?: Array<'background' | 'created' | 'enablement_status' | 'id' | 'metadata' | 'metadata.app_build' | 'metadata.app_id' | 'metadata.app_name' | 'metadata.app_version' | 'metadata.device_id' | 'metadata.device_model' | 'metadata.environment' | 'metadata.klaviyo_sdk' | 'metadata.manufacturer' | 'metadata.os_name' | 'metadata.os_version' | 'metadata.sdk_version' | 'platform' | 'recorded_date' | 'token' | 'vendor'>, filter?: string, include?: Array<'conversations' | 'push-tokens'>, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'email' | '-email' | 'id' | '-id' | 'subscriptions.email.marketing.list_suppressions.timestamp' | '-subscriptions.email.marketing.list_suppressions.timestamp' | 'subscriptions.email.marketing.suppression.timestamp' | '-subscriptions.email.marketing.suppression.timestamp' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetProfileResponsePluralConversationsCollectionCompoundDocument;  }> {
        ...
        if (options.include !== undefined) {
            localVarQueryParameters['include'] = ObjectSerializer.serialize(options.include, "Array<'conversations' | 'push-tokens'>");
        }
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetProfileResponsePluralConversationsCollectionCompoundDocument;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetProfileResponsePluralConversationsCollectionCompoundDocument");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param id 
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.
     */
     ...
     * @param id The value of the push token
     * @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsPushToken For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships
     */
    public async getPushToken (id: string, options: { fieldsProfile?: Array<'created' | 'email' | 'external_id' | 'first_name' | 'id' | 'image' | 'last_event_date' | 'last_name' | 'locale' | 'location' | 'location.address1' | 'location.address2' | 'location.city' | 'location.country' | 'location.ip' | 'location.latitude' | 'location.longitude' | 'location.region' | 'location.timezone' | 'location.zip' | 'organization' | 'phone_number' | 'properties' | 'title' | 'updated'>, fieldsPushToken?: Array<'background' | 'created' | 'enablement_status' | 'id' | 'metadata' | 'metadata.app_build' | 'metadata.app_id' | 'metadata.app_name' | 'metadata.app_version' | 'metadata.device_id' | 'metadata.device_model' | 'metadata.environment' | 'metadata.klaviyo_sdk' | 'metadata.manufacturer' | 'metadata.os_name' | 'metadata.os_version' | 'metadata.sdk_version' | 'platform' | 'recorded_date' | 'token' | 'vendor'>, include?: Array<'profile'>,  } = {}): Promise<{ response: AxiosResponse; body: GetPushTokenResponseCompoundDocument;  }> {
     ...
     * @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsPushToken For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;profile.id&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;enablement_status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;platform&#x60;: &#x60;equals&#x60;* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.
     */
     ...
     * @param id 
     * @param fieldsPushToken For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getPushTokensForProfile (id: string, options: { fieldsPushToken?: Array<'background' | 'created' | 'enablement_status' | 'id' | 'metadata' | 'metadata.app_build' | 'metadata.app_id' | 'metadata.app_name' | 'metadata.app_version' | 'metadata.device_id' | 'metadata.device_model' | 'metadata.environment' | 'metadata.klaviyo_sdk' | 'metadata.manufacturer' | 'metadata.os_name' | 'metadata.os_version' | 'metadata.sdk_version' | 'platform' | 'recorded_date' | 'token' | 'vendor'>,  } = {}): Promise<{ response: AxiosResponse; body: GetPushTokenResponseCollection;  }> {
     ...
     * @param id 
     * @param fieldsSegment For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async getSegmentsForProfile (id: string, options: { fieldsSegment?: Array<'created' | 'definition' | 'definition.condition_groups' | 'id' | 'is_active' | 'is_processing' | 'is_starred' | 'name' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetSegmentResponseCollection;  }> {
     ...
     * @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async mergeProfiles (profileMergeQuery: ProfileMergeQuery, options: { fieldsProfile?: Array<'id'>,  } = {}): Promise<{ response: AxiosResponse; body: PostProfileMergeResponse;  }> {
        ...
        if (options.fieldsProfile !== undefined) {
            localVarQueryParameters['fields[profile]'] = ObjectSerializer.serialize(options.fieldsProfile, "Array<'id'>");
        }
     ...
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async updateProfile (id: string, profilePartialUpdateQuery: ProfilePartialUpdateQuery, options: { additionalFieldsProfile?: Array<'subscriptions' | 'predictive_analytics'>, fieldsProfile?: Array<'created' | 'email' | 'external_id' | 'first_name' | 'id' | 'image' | 'last_event_date' | 'last_name' | 'locale' | 'location' | 'location.address1' | 'location.address2' | 'location.city' | 'location.country' | 'location.ip' | 'location.latitude' | 'location.longitude' | 'location.region' | 'location.timezone' | 'location.zip' | 'organization' | 'phone_number' | 'predictive_analytics' | 'predictive_analytics.average_days_between_orders' | 'predictive_analytics.average_order_value' | 'predictive_analytics.churn_probability' | 'predictive_analytics.expected_date_of_next_order' | 'predictive_analytics.historic_clv' | 'predictive_analytics.historic_number_of_orders' | 'predictive_analytics.predicted_clv' | 'predictive_analytics.predicted_number_of_orders' | 'predictive_analytics.ranked_channel_affinity' | 'predictive_analytics.total_clv' | 'properties' | 'subscriptions' | 'subscriptions.email' | 'subscriptions.email.marketing' | 'subscriptions.email.marketing.can_receive_email_marketing' | 'subscriptions.email.marketing.consent' | 'subscriptions.email.marketing.consent_timestamp' | 'subscriptions.email.marketing.custom_method_detail' | 'subscriptions.email.marketing.double_optin' | 'subscriptions.email.marketing.last_updated' | 'subscriptions.email.marketing.list_suppressions' | 'subscriptions.email.marketing.method' | 'subscriptions.email.marketing.method_detail' | 'subscriptions.email.marketing.suppression' | 'subscriptions.email.open_tracking' | 'subscriptions.email.open_tracking.can_receive' | 'subscriptions.email.open_tracking.consent' | 'subscriptions.email.open_tracking.consent_timestamp' | 'subscriptions.email.open_tracking.created_timestamp' | 'subscriptions.email.open_tracking.last_updated' | 'subscriptions.email.open_tracking.metadata' | 'subscriptions.email.open_tracking.valid_until' | 'subscriptions.mobile_push' | 'subscriptions.mobile_push.marketing' | 'subscriptions.mobile_push.marketing.can_receive_push_marketing' | 'subscriptions.mobile_push.marketing.consent' | 'subscriptions.mobile_push.marketing.consent_timestamp' | 'subscriptions.sms' | 'subscriptions.sms.marketing' | 'subscriptions.sms.marketing.can_receive_sms_marketing' | 'subscriptions.sms.marketing.consent' | 'subscriptions.sms.marketing.consent_timestamp' | 'subscriptions.sms.marketing.last_updated' | 'subscriptions.sms.marketing.method' | 'subscriptions.sms.marketing.method_detail' | 'subscriptions.sms.transactional' | 'subscriptions.sms.transactional.can_receive_sms_transactional' | 'subscriptions.sms.transactional.consent' | 'subscriptions.sms.transactional.consent_timestamp' | 'subscriptions.sms.transactional.last_updated' | 'subscriptions.sms.transactional.method' | 'subscriptions.sms.transactional.method_detail' | 'subscriptions.whatsapp' | 'subscriptions.whatsapp.conversational' | 'subscriptions.whatsapp.conversational.can_receive' | 'subscriptions.whatsapp.conversational.consent' | 'subscriptions.whatsapp.conversational.consent_timestamp' | 'subscriptions.whatsapp.conversational.created_timestamp' | 'subscriptions.whatsapp.conversational.last_updated' | 'subscriptions.whatsapp.conversational.metadata' | 'subscriptions.whatsapp.conversational.phone_number' | 'subscriptions.whatsapp.conversational.valid_until' | 'subscriptions.whatsapp.marketing' | 'subscriptions.whatsapp.marketing.can_receive' | 'subscriptions.whatsapp.marketing.consent' | 'subscriptions.whatsapp.marketing.consent_timestamp' | 'subscriptions.whatsapp.marketing.created_timestamp' | 'subscriptions.whatsapp.marketing.last_updated' | 'subscriptions.whatsapp.marketing.metadata' | 'subscriptions.whatsapp.marketing.phone_number' | 'subscriptions.whatsapp.marketing.valid_until' | 'subscriptions.whatsapp.transactional' | 'subscriptions.whatsapp.transactional.can_receive' | 'subscriptions.whatsapp.transactional.consent' | 'subscriptions.whatsapp.transactional.consent_timestamp' | 'subscriptions.whatsapp.transactional.created_timestamp' | 'subscriptions.whatsapp.transactional.last_updated' | 'subscriptions.whatsapp.transactional.metadata' | 'subscriptions.whatsapp.transactional.phone_number' | 'subscriptions.whatsapp.transactional.valid_until' | 'title' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: PatchProfileResponse;  }> {
...
export interface ProfilesApi {
    /**
     * Alias of {@link ProfilesApi.getConversationIdsForProfile}
     *
     * @deprecated Use {@link ProfilesApi.getConversationIdsForProfile} instead
     */
    getProfileRelationshipsConversations: typeof ProfilesApi.prototype.getConversationIdsForProfile;
}
ProfilesApi.prototype.getProfileRelationshipsConversations = ProfilesApi.prototype.getConversationIdsForProfile

export interface ProfilesApi {
    /**
     * Alias of {@link ProfilesApi.getConversationsForProfile}
     *
     * @deprecated Use {@link ProfilesApi.getConversationsForProfile} instead
     */
    getProfileConversations: typeof ProfilesApi.prototype.getConversationsForProfile;
}
ProfilesApi.prototype.getProfileConversations = ProfilesApi.prototype.getConversationsForProfile
