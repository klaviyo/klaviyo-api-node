...
export class FlowsApi {
    ...
    public async getActionForFlowMessage (id: string, options: { fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponse;  }> {
        ...
        if (options.fieldsFlowAction !== undefined) {
            localVarQueryParameters['fields[flow-action]'] = ObjectSerializer.serialize(options.fieldsFlowAction, "Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>");
        }
     ...
     * @param id 
     * @param filter For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;action_type&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sorting
     */
     ...
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;action_type&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sorting
     */
    public async getActionsForFlow (id: string, options: { fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>, filter?: string, pageCursor?: string, pageSize?: number, sort?: 'action_type' | '-action_type' | 'created' | '-created' | 'id' | '-id' | 'status' | '-status' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCollection;  }> {
     ...
     * @summary Get Flow
     * @param id 
     * @param additionalFieldsFlow Request additional fields not included by default in the response. Supported values: \&#39;definition\&#39;* @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#relationships
     */
    public async getFlow (id: string, options: { additionalFieldsFlow?: Array<'definition'>, fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>, fieldsFlow?: Array<'name' | 'status' | 'archived' | 'created' | 'updated' | 'trigger_type' | 'definition' | 'definition.triggers' | 'definition.profile_filter' | 'definition.profile_filter.condition_groups' | 'definition.actions' | 'definition.entry_action_id'>, fieldsTag?: Array<'name'>, include?: Array<'flow-actions' | 'tags'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowV2ResponseCompoundDocument;  }> {
     ...
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#relationships
     */
    public async getFlowAction (id: string, options: { fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>, fieldsFlowMessage?: Array<'created' | 'updated' | 'definition' | 'definition.from_email' | 'definition.from_label' | 'definition.reply_to_email' | 'definition.cc_email' | 'definition.bcc_email' | 'definition.subject_line' | 'definition.preview_text' | 'definition.template_id' | 'definition.smart_sending_enabled' | 'definition.transactional' | 'definition.add_tracking_params' | 'definition.custom_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.name' | 'definition.id' | 'definition.to_emails' | 'definition.title' | 'definition.body' | 'definition.sound' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.value' | 'definition.badge_options.set_from_property' | 'definition.image_id' | 'definition.dynamic_image' | 'definition.on_open' | 'definition.ios_link' | 'definition.android_link' | 'definition.conversion_metric_id' | 'definition.shorten_links' | 'definition.include_contact_card' | 'definition.add_org_prefix' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.sms_quiet_hours_enabled' | 'definition.url' | 'definition.headers' | 'definition.vendor_id'>, fieldsFlow?: Array<'name' | 'status' | 'archived' | 'created' | 'updated' | 'trigger_type'>, include?: Array<'flow' | 'flow-messages'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCompoundDocument;  }> {
        ...
        if (options.fieldsFlowMessage !== undefined) {
            localVarQueryParameters['fields[flow-message]'] = ObjectSerializer.serialize(options.fieldsFlowMessage, "Array<'created' | 'updated' | 'definition' | 'definition.from_email' | 'definition.from_label' | 'definition.reply_to_email' | 'definition.cc_email' | 'definition.bcc_email' | 'definition.subject_line' | 'definition.preview_text' | 'definition.template_id' | 'definition.smart_sending_enabled' | 'definition.transactional' | 'definition.add_tracking_params' | 'definition.custom_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.name' | 'definition.id' | 'definition.to_emails' | 'definition.title' | 'definition.body' | 'definition.sound' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.value' | 'definition.badge_options.set_from_property' | 'definition.image_id' | 'definition.dynamic_image' | 'definition.on_open' | 'definition.ios_link' | 'definition.android_link' | 'definition.conversion_metric_id' | 'definition.shorten_links' | 'definition.include_contact_card' | 'definition.add_org_prefix' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.sms_quiet_hours_enabled' | 'definition.url' | 'definition.headers' | 'definition.vendor_id'>");
        }
     ...
     * @param id 
     * @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sorting
     */
    public async getFlowActionMessages (id: string, options: { fieldsFlowMessage?: Array<'created' | 'updated' | 'definition' | 'definition.from_email' | 'definition.from_label' | 'definition.reply_to_email' | 'definition.cc_email' | 'definition.bcc_email' | 'definition.subject_line' | 'definition.preview_text' | 'definition.template_id' | 'definition.smart_sending_enabled' | 'definition.transactional' | 'definition.add_tracking_params' | 'definition.custom_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.name' | 'definition.id' | 'definition.to_emails' | 'definition.title' | 'definition.body' | 'definition.sound' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.value' | 'definition.badge_options.set_from_property' | 'definition.image_id' | 'definition.dynamic_image' | 'definition.on_open' | 'definition.ios_link' | 'definition.android_link' | 'definition.conversion_metric_id' | 'definition.shorten_links' | 'definition.include_contact_card' | 'definition.add_org_prefix' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.sms_quiet_hours_enabled' | 'definition.url' | 'definition.headers' | 'definition.vendor_id'>, filter?: string, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'id' | '-id' | 'name' | '-name' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCollection;  }> {
     ...
     * @param id 
     * @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets
     */
     ...
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsTemplate For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#relationships
     */
    public async getFlowMessage (id: string, options: { fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>, fieldsFlowMessage?: Array<'created' | 'updated' | 'definition' | 'definition.from_email' | 'definition.from_label' | 'definition.reply_to_email' | 'definition.cc_email' | 'definition.bcc_email' | 'definition.subject_line' | 'definition.preview_text' | 'definition.template_id' | 'definition.smart_sending_enabled' | 'definition.transactional' | 'definition.add_tracking_params' | 'definition.custom_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.name' | 'definition.id' | 'definition.to_emails' | 'definition.title' | 'definition.body' | 'definition.sound' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.value' | 'definition.badge_options.set_from_property' | 'definition.image_id' | 'definition.dynamic_image' | 'definition.on_open' | 'definition.ios_link' | 'definition.android_link' | 'definition.conversion_metric_id' | 'definition.shorten_links' | 'definition.include_contact_card' | 'definition.add_org_prefix' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.sms_quiet_hours_enabled' | 'definition.url' | 'definition.headers' | 'definition.vendor_id'>, fieldsTemplate?: Array<'name' | 'editor_type' | 'html' | 'text' | 'amp' | 'created' | 'updated'>, include?: Array<'flow-action' | 'template'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCompoundDocument;  }> {
     ...
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;archived&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;trigger_type&#x60;: &#x60;equals&#x60;* @param include For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#relationships* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sorting
     */
    public async getFlows (options: { fieldsFlowAction?: Array<'created' | 'updated' | 'definition' | 'definition.id' | 'definition.temporary_id' | 'definition.type' | 'definition.links' | 'definition.links.next_if_true' | 'definition.links.next_if_false' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.links.next' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.message' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.reply_to_email' | 'definition.data.message.cc_email' | 'definition.data.message.bcc_email' | 'definition.data.message.subject_line' | 'definition.data.message.preview_text' | 'definition.data.message.template_id' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.transactional' | 'definition.data.message.add_tracking_params' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.name' | 'definition.data.message.id' | 'definition.data.status' | 'definition.data.message.title' | 'definition.data.message.body' | 'definition.data.message.sound' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.value' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.image_id' | 'definition.data.message.dynamic_image' | 'definition.data.message.on_open' | 'definition.data.message.ios_link' | 'definition.data.message.android_link' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.shorten_links' | 'definition.data.message.include_contact_card' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.url' | 'definition.data.message.headers' | 'definition.data.message.to_emails' | 'definition.data.message.vendor_id' | 'definition.data.unit' | 'definition.data.value' | 'definition.data.secondary_value' | 'definition.data.timezone' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_type' | 'definition.data.trigger_subtype' | 'definition.data.profile_operations' | 'definition.data.target_time' | 'definition.data.target_days' | 'definition.data.experiment_status' | 'definition.data.main_action' | 'definition.data.main_action.id' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.current_experiment' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.winner_metric' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.list_id'>, fieldsFlow?: Array<'name' | 'status' | 'archived' | 'created' | 'updated' | 'trigger_type'>, fieldsTag?: Array<'name'>, filter?: string, include?: Array<'flow-actions' | 'tags'>, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'id' | '-id' | 'name' | '-name' | 'status' | '-status' | 'trigger_type' | '-trigger_type' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowResponseCollectionCompoundDocument;  }> {
     ...
     * @param id 
     * @param filter For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sorting
     */
     ...
     * @param id 
     * @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets
     */
     ...
     * @param id 
     * @param fieldsTemplate For more information please visit https://developers.klaviyo.com/en/v2025-10-15/reference/api-overview#sparse-fieldsets
     */
