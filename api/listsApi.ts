...
export class ListsApi {
     ...
     */
    public async createList (listCreateQuery: ListCreateQuery, options: { fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: PostListCreateResponse;  }> {
     ...
     */
    public async getFlowsTriggeredByList (id: string, options: { fieldsFlow?: Array<'archived' | 'created' | 'id' | 'name' | 'status' | 'trigger_type' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowResponseCollection;  }> {
     ...
     * @summary Get List
     * @param id Primary key that uniquely identifies this list. Generated by Klaviyo.
     * @param additionalFieldsList Request additional fields not included by default in the response. Supported values: \&#39;profile_count\&#39;* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships
     */
    public async getList (id: string, options: { additionalFieldsList?: Array<'profile_count'>, fieldsFlow?: Array<'archived' | 'created' | 'id' | 'name' | 'status' | 'trigger_type' | 'updated'>, fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'profile_count' | 'updated'>, fieldsTag?: Array<'id' | 'name'>, include?: Array<'flow-triggers' | 'tags'>,  } = {}): Promise<{ response: AxiosResponse; body: GetListRetrieveResponseCompoundDocument;  }> {
        ...
        if (options.fieldsList !== undefined) {
            localVarQueryParameters['fields[list]'] = ObjectSerializer.serialize(options.fieldsList, "Array<'created' | 'id' | 'name' | 'opt_in_process' | 'profile_count' | 'updated'>");
        }
     ...
     * @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;name&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;greater-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;greater-than&#x60;* @param include For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#relationships* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 10. Min: 1. Max: 10.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
    public async getLists (options: { fieldsFlow?: Array<'archived' | 'created' | 'id' | 'name' | 'status' | 'trigger_type' | 'updated'>, fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>, fieldsTag?: Array<'id' | 'name'>, filter?: string, include?: Array<'flow-triggers' | 'tags'>, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'id' | '-id' | 'name' | '-name' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetListListResponseCollectionCompoundDocument;  }> {
     ...
     * @param id Primary key that uniquely identifies this list. Generated by Klaviyo.
     * @param additionalFieldsProfile Request additional fields not included by default in the response. Supported values: \&#39;subscriptions\&#39;, \&#39;predictive_analytics\&#39;* @param fieldsProfile For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;email&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;phone_number&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;push_token&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;_kx&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;joined_group_at&#x60;: &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#pagination* @param pageSize Default: 20. Min: 1. Max: 100.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sorting
     */
     ...
     */
    public async getTagsForList (id: string, options: { fieldsTag?: Array<'id' | 'name'>,  } = {}): Promise<{ response: AxiosResponse; body: GetTagResponseCollection;  }> {
     ...
     * @param fieldsList For more information please visit https://developers.klaviyo.com/en/v2026-07-15/reference/api-overview#sparse-fieldsets
     */
    public async updateList (id: string, listPartialUpdateQuery: ListPartialUpdateQuery, options: { fieldsList?: Array<'created' | 'id' | 'name' | 'opt_in_process' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: PatchListPartialUpdateResponse;  }> {
