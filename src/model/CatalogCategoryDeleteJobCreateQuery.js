...
import {CatalogCategoryDeleteJobCreateQueryAsSubResource} from './CatalogCategoryDeleteJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogCategoryDeleteJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
