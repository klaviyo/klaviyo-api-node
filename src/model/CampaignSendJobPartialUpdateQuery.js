...
import {CampaignSendJobPartialUpdateQueryAsSubResource} from './CampaignSendJobPartialUpdateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CampaignSendJobPartialUpdateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
