...
import {TemplateRenderQueryAsSubResource} from './TemplateRenderQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = TemplateRenderQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
