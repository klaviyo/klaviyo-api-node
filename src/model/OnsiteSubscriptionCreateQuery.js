...
import {OnsiteSubscriptionCreateQueryResourceObject} from './OnsiteSubscriptionCreateQueryResourceObject.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = OnsiteSubscriptionCreateQueryResourceObject.constructFromObject(data['data']);
    }
    return obj;
  }
}
