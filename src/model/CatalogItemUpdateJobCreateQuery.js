...
import {CatalogItemUpdateJobCreateQueryAsSubResource} from './CatalogItemUpdateJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogItemUpdateJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
