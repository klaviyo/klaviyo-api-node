...
import {CatalogVariantUpdateJobCreateQueryAsSubResourceAttributes} from './CatalogVariantUpdateJobCreateQueryAsSubResourceAttributes.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = CatalogVariantUpdateJobCreateQueryAsSubResourceAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
}
