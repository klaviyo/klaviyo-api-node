...
import {UnsubscriptionCreateJobCreateQueryAsSubResource} from './UnsubscriptionCreateJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = UnsubscriptionCreateJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
