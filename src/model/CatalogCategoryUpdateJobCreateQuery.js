...
import {CatalogCategoryUpdateJobCreateQueryAsSubResource} from './CatalogCategoryUpdateJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogCategoryUpdateJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
