...
import {SegmentPartialUpdateQueryAsSubResourceAttributes} from './SegmentPartialUpdateQueryAsSubResourceAttributes.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SegmentPartialUpdateQueryAsSubResourceAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
}
