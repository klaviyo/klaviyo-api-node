...
import {UnsuppressionCreateJobCreateQueryAsSubResource} from './UnsuppressionCreateJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = UnsuppressionCreateJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
