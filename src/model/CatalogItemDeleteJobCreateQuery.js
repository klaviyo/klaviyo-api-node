...
import {CatalogItemDeleteJobCreateQueryResourceObject} from './CatalogItemDeleteJobCreateQueryResourceObject.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogItemDeleteJobCreateQueryResourceObject.constructFromObject(data['data']);
    }
    return obj;
  }
}
