...
import {CampaignRecipientEstimationJobCreateQueryAsSubResource} from './CampaignRecipientEstimationJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CampaignRecipientEstimationJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
