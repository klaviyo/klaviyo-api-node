...
import {CampaignPartialUpdateQueryAsSubResource} from './CampaignPartialUpdateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CampaignPartialUpdateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
