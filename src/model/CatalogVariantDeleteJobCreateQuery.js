...
import {CatalogVariantDeleteJobCreateQueryResourceObject} from './CatalogVariantDeleteJobCreateQueryResourceObject.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogVariantDeleteJobCreateQueryResourceObject.constructFromObject(data['data']);
    }
    return obj;
  }
}
