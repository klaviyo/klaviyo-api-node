...
import {CatalogItemCreateJobCreateQueryAsSubResource} from './CatalogItemCreateJobCreateQueryAsSubResource.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CatalogItemCreateJobCreateQueryAsSubResource.constructFromObject(data['data']);
    }
    return obj;
  }
}
