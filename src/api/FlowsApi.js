    ...
    */
    ...
    getFlowActionMessages = async (id, opts) => {
      ...
      // verify the required parameter 'id' is set
        ...
        let queryParams = {
          'fields[flow-message]': this.apiClient.buildCollectionParam(opts['fieldsFlowMessage'], 'csv'),'filter': opts['filter'],'page[cursor]': opts['pageCursor'],'page[size]': opts['pageSize'],'sort': opts['sort']
        };
        let headerParams = {
    ...
    getFlows = async (opts) => {
        ...
        let queryParams = {
          'fields[flow-action]': this.apiClient.buildCollectionParam(opts['fieldsFlowAction'], 'csv'),'fields[flow]': this.apiClient.buildCollectionParam(opts['fieldsFlow'], 'csv'),'filter': opts['filter'],'include': this.apiClient.buildCollectionParam(opts['include'], 'csv'),'page[cursor]': opts['pageCursor'],'page[size]': opts['pageSize'],'sort': opts['sort']
        };
        let headerParams = {
