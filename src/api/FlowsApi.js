    ...
    */
    ...
    getFlowActionMessages = async (actionId, opts) => {
      ...
      // verify the required parameter 'actionId' is set
        ...
        let queryParams = {
          'fields[flow-message]': this.apiClient.buildCollectionParam(opts['fieldsFlowMessage'], 'csv'),'filter': opts['filter'],'page[cursor]': opts['pageCursor'],'sort': opts['sort']
        };
        let headerParams = {
    ...
    getFlowActionRelationshipsMessages = async (id, opts) => {
      ...
      // verify the required parameter 'id' is set
        ...
        let queryParams = {
          'filter': opts['filter'],'page[cursor]': opts['pageCursor'],'sort': opts['sort']
        };
        let headerParams = {
    ...
    getFlowFlowActions = async (flowId, opts) => {
      ...
      // verify the required parameter 'flowId' is set
        ...
        let queryParams = {
          'fields[flow-action]': this.apiClient.buildCollectionParam(opts['fieldsFlowAction'], 'csv'),'filter': opts['filter'],'page[cursor]': opts['pageCursor'],'sort': opts['sort']
        };
        let headerParams = {
    ...
    getFlows = async (opts) => {
        ...
        let queryParams = {
          'fields[flow-action]': this.apiClient.buildCollectionParam(opts['fieldsFlowAction'], 'csv'),'fields[flow]': this.apiClient.buildCollectionParam(opts['fieldsFlow'], 'csv'),'filter': opts['filter'],'include': this.apiClient.buildCollectionParam(opts['include'], 'csv'),'page[cursor]': opts['pageCursor'],'sort': opts['sort']
        };
        let headerParams = {
