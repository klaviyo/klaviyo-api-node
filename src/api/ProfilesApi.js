    ...
    */
    ...
    createProfile = async (body, opts) => {
      ...
      // verify the required parameter 'body' is set
        ...
        let queryParams = {
          'additional-fields[profile]': this.apiClient.buildCollectionParam(opts['additionalFieldsProfile'], 'csv')
        };
        let headerParams = {
    ...
    getProfiles = async (opts) => {
        ...
        let queryParams = {
          'additional-fields[profile]': this.apiClient.buildCollectionParam(opts['additionalFieldsProfile'], 'csv'),'fields[profile]': this.apiClient.buildCollectionParam(opts['fieldsProfile'], 'csv'),'filter': opts['filter'],'page[cursor]': opts['pageCursor'],'sort': opts['sort'],'page[size]': opts['pageSize']
        };
        let headerParams = {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    updateProfile = async (body, id, opts) => {
