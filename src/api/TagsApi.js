    ...
    */
    ...
    getTag = async (id, opts) => {
      ...
      // verify the required parameter 'id' is set
        ...
        let queryParams = {
          'fields[tag-group]': this.apiClient.buildCollectionParam(opts['fieldsTagGroup'], 'csv'),'fields[tag]': this.apiClient.buildCollectionParam(opts['fieldsTag'], 'csv'),'include': this.apiClient.buildCollectionParam(opts['include'], 'csv')
        };
        let headerParams = {
    ...
    getTags = async (opts) => {
        ...
        let queryParams = {
          'fields[tag-group]': this.apiClient.buildCollectionParam(opts['fieldsTagGroup'], 'csv'),'fields[tag]': this.apiClient.buildCollectionParam(opts['fieldsTag'], 'csv'),'filter': opts['filter'],'include': this.apiClient.buildCollectionParam(opts['include'], 'csv'),'page[cursor]': opts['pageCursor'],'sort': opts['sort']
        };
        let headerParams = {
